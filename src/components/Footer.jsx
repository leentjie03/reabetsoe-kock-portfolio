      ...
      <div className="footer-container">
        <div className="footer-content">
          <div className="footer-text">
            <p>&copy; 2024 Reabetsoe Kock. All rights reserved.</p>
            <p>Source code available on <a href="https://github.com/your-username/your-repo" target="_blank" rel="noopener noreferrer">GitHub</a>.</p>
          </div>
