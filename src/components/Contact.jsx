...
export default function ContactForm() {
  ...
  const handleSubmit = (e) => {
    ...
    if (!serviceId || !templateId || !publicKey) {
      setStatus("Email configuration missing. Please check setup.");
      return;
    }
          ...
          <div className="contact-intro">
            ...
            <p>
              ...
              <button 
                ...
                onClick={() => window.open('mailto:ieleenkock@gmail.com', '_self')}
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M12 13.5l-8-5h16l-8 5zm0 2.5l8-5v7H4v-7l8 5z"/>
                </svg>
                <span>ieleenkock@gmail.com</span>
              </button>
